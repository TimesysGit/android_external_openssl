...
target_c_includes := $(addprefix external/openssl-fips/,$(common_c_includes)) $(local_c_includes)
...
host_c_includes := $(addprefix external/openssl-fips/,$(common_c_includes)) $(local_c_includes)
